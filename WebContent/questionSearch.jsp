...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
	...
	<body>
		<h2> <%String keyword = request.getParameter("keyword"); 
			out.print("You are searching keyword:    '" + keyword+"'"); %></h2>
	<%
	try {
		...
		//Make an insert statement for the question table:
		...
		while (result.next()) {
			%>
			<div class="container">
	  		<p><%out.print(result.getString("question"));%></p>
			</div>
