...
<%
		...
		String cancel = "update reservations set status = 'canceled' where resNum = " + resNum;
		stmt.executeUpdate(cancel);
		out.println("Successfully canceled the reservation. <a href='home.jsp'>Click here to return home</a>");
